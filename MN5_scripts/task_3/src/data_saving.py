...
def save_data_to_files(t_grid, counts, L, T_max, R_shots, J_steps, 
    ...
    output_filename_counts = f'../data/experimental_data_{filename_core}_counts.csv'
    output_filename_metadata = f'../data/experimental_data_{filename_core}_metadata.npz'
    output_filename_config_df = f'../data/experimental_data_{filename_core}_config_df.csv'
