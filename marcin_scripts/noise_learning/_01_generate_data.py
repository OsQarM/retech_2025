...
CONFIG = {
    ...
    "hx_list_true": [0.3, 0.8, 0.4, 0.9],  # X field for each qubit
    "hz_list_true": [0.65, 0.2, 0.15, 0.43],   # Z field for each qubit
    "Jzz_list_true": [0.4, 0.25, 0.1],       # ZZ coupling for each bond (L-1 values)
